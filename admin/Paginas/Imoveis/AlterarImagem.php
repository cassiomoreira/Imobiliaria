...
if (filter_input(INPUT_POST, "btnGravar", FILTER_SANITIZE_STRING)) {
    if (filter_input(INPUT_GET, "id_cliente", FILTER_SANITIZE_NUMBER_INT)) {
        if ($clienteController->AlterarSenha(filter_input(INPUT_POST, "txtSenha", FILTER_SANITIZE_STRING), filter_input(INPUT_GET, "id_cliente", FILTER_SANITIZE_NUMBER_INT))) {
            ?>
            <script>
                document.cookie = "msg=1";
                document.location.href = "?pagina=alterarsenha&id_cliente=<?= filter_input(INPUT_GET, "id_cliente", FILTER_SANITIZE_NUMBER_INT) ?>";
            </script>
            <?php
        } else {
    ...
    <div class="panel panel-default maxPanelWidth">
        ...
        <div class="panel-body">
            <form method="post" id="frmAlterarSenha" name="frmAlterarSenha" novalidate>
                ...
                <div class="row">
                    <div class="col-lg-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="txtSenha" name="txtSenha" placeholder="*******"  />
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="txtSenha2" name="txtSenha2" placeholder="*******" />
                        </div>
                    </div>
                </div>
                ...
                <a href="?pagina=alterarsenha&id_cliente=<?= filter_input(INPUT_GET, "id_cliente", FILTER_SANITIZE_NUMBER_INT) ?>" class="btn btn-danger">Cancelar</a>
